...
wandb.config.episodes = args.num_episodes
...
for i_episode in range(args.num_episodes):
    ...
    while True:
        ...
        if player.done and not player.info:
            ...
            wandb.log({'episodic_reward': reward_sum})
            wandb.log({'cumulative_avg_reward': reward_mean})
...
mp4list = glob.glob("{}_monitor".format(args.env)+"/*.mp4")
if len(mp4list) > 0:
	mp4 = mp4list[-1]
